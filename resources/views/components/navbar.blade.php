...
<div class="mx-auto flex max-w-screen-2xl items-center justify-between px-6 py-4 lg:px-10">
        ...
        <nav class="hidden items-center gap-8 lg:flex" aria-label="Navigasi utama">
            <a href="#beranda"
               class="relative text-base font-medium text-slate-600 transition hover:text-blue-600 after:absolute after:-bottom-2 after:left-0 after:h-0.5 after:w-full after:origin-center after:scale-x-0 after:rounded-full after:bg-blue-600 after:transition-transform after:duration-300 hover:after:scale-x-100">
                Beranda
            </a>
            <a href="#fitur"
               class="relative text-base font-medium text-slate-600 transition hover:text-blue-600 after:absolute after:-bottom-2 after:left-0 after:h-0.5 after:w-full after:origin-center after:scale-x-0 after:rounded-full after:bg-blue-600 after:transition-transform after:duration-300 hover:after:scale-x-100">
        ...
        <div class="hidden items-center gap-3 lg:flex">
            <a href="#kontak"
               class="text-base font-semibold text-slate-600 transition hover:text-blue-600">
                Hubungi Kami
            </a>

            <a href="https://member.jvpartner.id/" target="_blank" rel="noopener noreferrer"
               class="rounded-xl bg-blue-600 px-5 py-2.5 text-base font-bold text-white shadow-lg shadow-blue-600/25 ring-1 ring-inset ring-white/40 transition hover:bg-blue-700 hover:shadow-blue-600/40">
                Join Member
            </a>
        </div>

        <button type="button" id="menu-toggle"
                class="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-white/60 text-slate-700 shadow-sm backdrop-blur transition hover:text-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 lg:hidden"
    ...
    <div id="mobile-menu" class="hidden bg-white/60 shadow-sm shadow-blue-900/5 backdrop-blur-xl lg:hidden">
        <nav class="flex flex-col gap-1 px-6 py-4" aria-label="Navigasi mobile">
            ...
            <div class="mt-2 flex flex-col gap-3 border-t border-white/30 pt-4 pb-1">
